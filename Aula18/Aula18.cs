...
class Aula18{
     static void Main(){
        ...
        /* O indice [3,5] indica uma tabela(matrix) com 3 linhas e 5 colunas como abaixo:
        ...
        */
        ...
        Console.WriteLine(n[2,1]);  //Trabando com dois indices um para colunas[] e outro para lihhas[0]
